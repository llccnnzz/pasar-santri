...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-size: ${metadata.styles?.font_size || '12px'};
...
<body>
    <div class="print-instructions">
        <h3>📋 Cara Mengubah ke PDF:</h3>
        <ol>
            <li>Tekan <strong>Ctrl+P</strong> (Windows/Linux) atau <strong>Cmd+P</strong> (Mac)</li>
            <li>Pilih <strong>"Save as PDF"</strong> sebagai destination</li>
            <li>Atur paper size ke <strong>A4</strong></li>
            <li>Pilih <strong>"More settings"</strong> dan centang <strong>"Headers and footers"</strong></li>
            <li>Klik <strong>"Save"</strong> dan simpan sebagai <strong>"User-Manual.pdf"</strong></li>
        </ol>
        <p><em>Instruksi ini akan hilang saat dicetak.</em></p>
    </div>
...
async function generateStats() {
    try {
        ...
        console.error('⚠️  Could not generate statistics:', error.message);
    }
}
