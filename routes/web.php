    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'role:admin']], function () {
        ...
        Route::group(['prefix' => 'sellers'], function () {
            Route::get('/', [AdminSellerController::class, 'index'])
                ->middleware('permission:admin-dashboard|index seller')
                ->name('admin.sellers.index');
            
            Route::get('/{user}', [AdminSellerController::class, 'show'])
                ->middleware('permission:admin-dashboard|show seller')
                ->name('admin.sellers.show');
            
            Route::put('/{user}', [AdminSellerController::class, 'update'])
                ->middleware('permission:admin-dashboard|update seller')
        ...
        Route::group(['prefix' => 'products'], function () {
            Route::get('/', [AdminProductController::class, 'index'])
                ->middleware('permission:admin-dashboard|index product')
                ->name('admin.products.index');
            
            Route::get('/{product}', [AdminProductController::class, 'show'])
                ->middleware('permission:admin-dashboard|show product')
                ->name('admin.products.show');
            
            Route::put('/{product}', [AdminProductController::class, 'update'])
                ->middleware('permission:admin-dashboard|update product')
        ...
        Route::group(['prefix' => 'orders'], function () {
            Route::get('/', [AdminOrderController::class, 'index'])
                ->middleware('permission:admin-dashboard|index order')
                ->name('admin.orders.index');
            
            Route::get('/{order}', [AdminOrderController::class, 'show'])
                ->middleware('permission:admin-dashboard|show order')
                ->name('admin.orders.show');
            
            Route::put('/{order}', [AdminOrderController::class, 'update'])
                ->middleware('permission:admin-dashboard|update order')
        ...
        Route::group(['prefix' => 'shipping-methods'], function () {
            Route::get('/', [AdminShippingController::class, 'index'])
                ->middleware('permission:admin-dashboard|index shipping method')
                ->name('admin.shipping.index');
            
            Route::get('/create', [AdminShippingController::class, 'create'])
                ->middleware('permission:admin-dashboard|create shipping method')
            ...
            Route::get('/{shippingMethod}', [AdminShippingController::class, 'show'])
                ->middleware('permission:admin-dashboard|show shipping method')
                ->name('admin.shipping.show');
            
            Route::get('/{shippingMethod}/edit', [AdminShippingController::class, 'edit'])
                ->middleware('permission:admin-dashboard|update shipping method')
            ...
            Route::delete('/{shippingMethod}', [AdminShippingController::class, 'destroy'])
                ->middleware('permission:admin-dashboard|delete shipping method')
        ...
        Route::group(['prefix' => 'banners'], function () {
            Route::get('/', [AdminBannerController::class, 'index'])
                ->middleware('permission:admin-dashboard|index banner')
                ->name('admin.banners.index');
            
            Route::get('/create', [AdminBannerController::class, 'create'])
                ->middleware('permission:admin-dashboard|create banner')
            ...
            Route::get('/{banner}', [AdminBannerController::class, 'show'])
                ->middleware('permission:admin-dashboard|show banner')
                ->name('admin.banners.show');
            
            Route::get('/{banner}/edit', [AdminBannerController::class, 'edit'])
                ->middleware('permission:admin-dashboard|update banner')
            ...
            Route::delete('/{banner}', [AdminBannerController::class, 'destroy'])
                ->middleware('permission:admin-dashboard|delete banner')
        ...
        Route::group(['prefix' => 'ads'], function () {
            Route::get('/', [AdminAdsController::class, 'index'])
                ->middleware('permission:admin-dashboard|index ads')
                ->name('admin.ads.index');
            
            Route::get('/create', [AdminAdsController::class, 'create'])
                ->middleware('permission:admin-dashboard|create ads')
            ...
            Route::get('/{productAd}', [AdminAdsController::class, 'show'])
                ->middleware('permission:admin-dashboard|show ads')
                ->name('admin.ads.show');
            
            Route::get('/{productAd}/edit', [AdminAdsController::class, 'edit'])
                ->middleware('permission:admin-dashboard|update ads')
                ->name('admin.ads.edit');
            ...
            Route::delete('/{productAd}', [AdminAdsController::class, 'destroy'])
                ->middleware('permission:admin-dashboard|delete ads')
        ...
        Route::group(['prefix' => 'promos'], function () {
            Route::get('/', [AdminPromoController::class, 'index'])
                ->middleware('permission:admin-dashboard|index promo')
                ->name('admin.promos.index');
            
            Route::get('/create', [AdminPromoController::class, 'create'])
                ->middleware('permission:admin-dashboard|create promo')
            ...
            Route::get('/{promotion}', [AdminPromoController::class, 'show'])
                ->middleware('permission:admin-dashboard|show promo')
                ->name('admin.promos.show');
            
            Route::get('/{promotion}/edit', [AdminPromoController::class, 'edit'])
                ->middleware('permission:admin-dashboard|update promo')
            ...
            Route::delete('/{promotion}', [AdminPromoController::class, 'destroy'])
                ->middleware('permission:admin-dashboard|delete promo')
        ...
        Route::group(['prefix' => 'service-fees'], function () {
            Route::get('/', [AdminServiceFeeController::class, 'index'])
                ->middleware('permission:admin-dashboard|index service fee')
                ->name('admin.service-fees.index');
            
            Route::get('/create', [AdminServiceFeeController::class, 'create'])
                ->middleware('permission:admin-dashboard|create service fee')
            ...
            Route::get('/{serviceFee}', [AdminServiceFeeController::class, 'show'])
                ->middleware('permission:admin-dashboard|show service fee')
                ->name('admin.service-fees.show');
            
            Route::get('/{serviceFee}/edit', [AdminServiceFeeController::class, 'edit'])
                ->middleware('permission:admin-dashboard|update service fee')
            ...
            Route::delete('/{serviceFee}', [AdminServiceFeeController::class, 'destroy'])
                ->middleware('permission:admin-dashboard|delete service fee')
        ...
        Route::group(['prefix' => 'analytics'], function () {
            Route::get('/dashboard', [AdminController::class, 'analyticsDashboard'])
                ->middleware('permission:admin-dashboard|show analytics')
        ...
        Route::group(['prefix' => 'settings'], function () {
            Route::get('/', [AdminController::class, 'settings'])
                ->middleware('permission:admin-dashboard|show settings')
                ->name('admin.settings.index');
            
            Route::put('/update', [AdminController::class, 'updateSettings'])
                ->middleware('permission:admin-dashboard|update settings')
