            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <p class="form-control-plaintext">{{ $kyc->province }}</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label font-weight-bold">Subdistrict</label>
                                <p class="form-control-plaintext">{{ $kyc->subdistrict }}</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label font-weight-bold">Village</label>
                                <p class="form-control-plaintext">{{ $kyc->village }}</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <p class="form-control-plaintext">
                                    {{ $kyc->document_expiry_date ? $kyc->document_expiry_date->format('M d, Y') : '-' }}
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="card">
                                        <img src="{{ $kyc->getFirstMediaUrl('document_front', 'preview') }}"
                                            class="card-img-top" alt="Document Front"
                                            style="height: 200px; object-fit: cover;">
                                        <div class="card-body p-2">
                                            <a href="{{ $kyc->getFirstMediaUrl('document_front') }}" target="_blank"
                        ...
                        @if ($kyc->getFirstMedia('selfie'))
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="card">
                                        <img src="{{ $kyc->getFirstMediaUrl('selfie', 'preview') }}" class="card-img-top"
                                            alt="Selfie" style="height: 200px; object-fit: cover;">
                                        <div class="card-body p-2">
                                            <a href="{{ $kyc->getFirstMediaUrl('selfie') }}" target="_blank"
                                                class="btn btn-sm btn-outline-primary btn-block">
                                                <i class="ri-expand-diagonal-line"></i> View Full Size
                                            </a>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="card">
                                            @if (str_contains($media->mime_type, 'image'))
                                                <img src="{{ $media->getUrl('preview') }}" class="card-img-top"
                                                    alt="Additional Document" style="height: 150px; object-fit: cover;">
                                            @else
                    ...
                    <div class="timeline">
                        ...
                        @if ($kyc->reviewed_at)
                            <div class="timeline-item">
                                <div class="timeline-marker bg-{{ $kyc->status === 'approved' ? 'success' : 'danger' }}">
                                </div>
                                <div class="timeline-content">
