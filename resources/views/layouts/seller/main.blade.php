...
<body>
    ...
    <div class="sidebar-menu-area" id="metismenu" data-simplebar>
        <div
            class="d-flex justify-content-between align-items-center border-bottom border-color bg-white position-sticky top-0 z-1 main-logo-wrap">
            <a href="index.html" class="main-logo d-flex align-items-center text-decoration-none">
                <img class="logo" src="/admin-assets/assets/images/logo.png" style="height: 80px; width: auto"
                    alt="logo">
            </a>
     ...
     <a href="#" class="menu-title">
      ...
      <span class="title">SKU Management</span>
            ...
            <li class="{{ request()->routeIs('seller.orders.*') ? 'mm-active' : '' }}">
                <a href="#" class="has-arrow menu-title"
                    aria-expanded="{{ request()->routeIs('seller.orders.*') ? 'true' : 'false' }}">
                    <span class="icon"><i data-feather="shopping-cart"></i></span>
                    <span class="title">Orders</span>
                </a>
                @php
                    $status = $currentStatus ?? request()->get('status');
                @endphp
                <ul class="sidemenu-second-level">
                    <li><a href="{{ route('seller.orders.index') }}?status=paid"
                            class="{{ $status === 'paid' ? 'active' : '' }}">New Orders</a></li>
                    <li><a href="{{ route('seller.orders.index') }}?status=confirmed"
                            class="{{ $status === 'confirmed' ? 'active' : '' }}">Confirmed</a></li>
                    <li><a href="{{ route('seller.orders.index') }}?status=processing"
                            class="{{ $status === 'processing' ? 'active' : '' }}">Processing</a></li>
                    <li><a href="{{ route('seller.orders.index') }}?status=shipped"
                            class="{{ $status === 'shipped' ? 'active' : '' }}">Shipped</a></li>
                    <li><a href="{{ route('seller.orders.index') }}?status=delivered"
                            class="{{ $status === 'delivered' ? 'active' : '' }}">Delivered</a></li>
                    <li><a href="{{ route('seller.orders.index') }}?status=finished"
                            class="{{ $status === 'finished' ? 'active' : '' }}">Finished</a></li>
                    <li><a href="{{ route('seller.orders.index') }}?status=cancelled"
                            class="{{ $status === 'cancelled' ? 'active' : '' }}">Cancelled</a></li>
                </ul>
            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-sm-6">
                        <div class="header-left-content">
                            <ul
                                class="list-unstyled ps-0 mb-0 d-flex justify-content-center justify-content-lg-start justify-content-md-start align-items-center">
                                <li>
                                ...
                                <li>
                                    <form class="src-form position-relative z-1">
                                        ...
                                        <button
                                            class="bg-transparent position-absolute position-absolute top-50 end-0 translate-middle border-0 ps-0 pe-1">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="header-right-content float-lg-end float-md-end">
                            <ul
                                class="list-unstyled ps-0 mb-0 d-flex justify-content-center justify-content-lg-end justify-content-md-end align-items-center">


                                <li class="ms-lg-4 ms-md-4 ms-2">
                                    <div class="dropdown mail">
                                        <button class="btn btn-secondary fullscreen-btn border-0 p-0 position-relative"
                                ...
                                <li class="ms-lg-4 ms-md-4 ms-2">
                                    <div class="dropdown mail apps">
                                        <button class="btn btn-secondary border-0 p-0" type="button"
                                        ...
                                        <div class="dropdown-menu dropdown-lg p-0 border-0 box-shadow">
                                            <h6
                                                ...
                                                Apps
                                                <span
                                                    class="text-white bg-danger fs-12 py-1 px-1 rounded-1 fw-normal">12</span>
                                            </h6>

                                            <div class="h-255" data-simplebar>
                                                <div
                                                    class="apps-menu d-flex flex-wrap align-items-center justify-content-center">
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/gmail.png"
                                                            alt="gmail">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Gmail</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/playstore.png"
                                                            alt="playstore">
                                                        <span class="d-block fs-14 fw-medium text-dark mt-2">Play
                                                            Store</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/drive.png"
                                                            alt="drive">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Drive</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/account.png"
                                                            alt="account">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Account</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/calender.png"
                                                            alt="calender">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Calender</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/figma.png"
                                                            alt="figma">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Figma</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/google-sheets.png"
                                                            alt="google-sheets">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Sheets</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/google.png"
                                                            alt="google">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Google</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/microsoft-word.png"
                                                            alt="microsoft-word">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Microsoft</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/powerpoint.png"
                                                            alt="powerpoint">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Powerpoint</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/sketch.png"
                                                            alt="sketch">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Sketch</span>
                                                    </a>
                                                    <a href="javascript:;" class="dropdown-item m-2 border-1">
                                                        <img src="/admin-assets/assets/images/apps/translate.png"
                                                            alt="translate">
                                                        <span
                                                            class="d-block fs-14 fw-medium text-dark mt-2">Translate</span>
                                                    </a>
                                                </div>
                                            </div>
                                            <a href="javascript:;"
                                                class="dropdown-item text-center text-white border-top border-color py-2 d-block bg-primary rounded-bottom z-1 position-relative fs-15">
                                                View all
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <li class="ms-lg-4 ms-md-4 ms-2">
                                    <div class="dropdown user-profile">
                                        <div class="btn border-0 p-0 d-flex align-items-center text-start"
                                            data-bs-toggle="dropdown">
                                            <div class="flex-shrink-0">
                                                <img class="rounded-circle user"
                                                    src="/admin-assets/assets/images/user/user.png" alt="user">
                                            </div>
                                            <div class="flex-grow-1 ms-2 d-none d-xxl-block">
                                                <h3 class="fs-14 mb-0">{{ auth()->user()->name }}</h3>
                                                <span
                                                    class="fs-13 text-body">{{ auth()->user()->shop->name ?? 'Unknown' }}</span>
                                            </div>
                                        </div>
                                        <ul class="dropdown-menu border-0 rounded box-shadow">
                                            <li>
                                                <div
                                                    class=" text-center border-bottom border-color pb-10 mb-10 d-xxl-none">
                                                    <h3 class="fs-14 mb-0">{{ auth()->user()->name }}</h3>
                                                    <span
                                                        class="fs-13 text-body">{{ auth()->user()->role ?? 'Unknown' }}</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="dropdown-item d-flex align-items-center text-body">
                                                    Rp. <span
                                                        class="ms-2 fs-14 fw-semibold text-dark">{{ number_format(auth()->user()->balance) }}</span>
                                                </div>
                                            </li>
                                            <li>
    ...
    <button class="setting-btn position-fixed bottom-0 end-0" type="button" data-bs-toggle="offcanvas"
        data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
        <i data-feather="settings"></i>
    </button>

    <div class="offcanvas offcanvas-end them-setting-content border-0" data-bs-scroll="true" data-bs-backdrop="false"
