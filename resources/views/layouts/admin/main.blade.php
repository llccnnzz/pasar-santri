                                        ...
                                        <button class="btn btn-secondary border-0 p-0 position-relative"
                                            ...
                                            @if (auth()->user()->unreadNotifications()->where('type', 'App\Notifications\AdminNotification')->count() > 0)
                                                <span
                                                    ...
                                                    {{ auth()->user()->unreadNotifications()->where('type', 'App\Notifications\AdminNotification')->count() }}
                                                </span>
                                            @endif
                                        </button>
                                        ...
                                        <div class="dropdown-menu dropdown-lg p-0 border-0 box-shadow">
                                            <h6
                                                ...
                                                <span class="text-white bg-danger fs-12 py-1 px-1 rounded-1 fw-normal">
                                                    {{ auth()->user()->notifications()->where('type', 'App\Notifications\AdminNotification')->count() }}
                                                </span>
                                            </h6>

                                            <div class="notification-menu h-400" data-simplebar>
                                                @foreach (auth()->user()->notifications()->where('type', 'App\Notifications\AdminNotification')->orderBy('read_at', 'desc')->take(10)->get() as $notif)
                                                    @php
                                                        $data = $notif->data;
                                                    @endphp
                                                    <div
                                                        ...
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="text-center ms-2">
                                                                ...
                                                                @if (!$notif->read_at)
                                                                    <form
                                                                        action="{{ route('admin.notifications.markAsRead', $notif['id']) }}"
                                            ...
                                            <a href="{{ route('admin.notifications.index', 'admin') }}"
